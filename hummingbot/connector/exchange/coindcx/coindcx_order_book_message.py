...
class CoindcxOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(CoindcxOrderBookMessage, cls).__new__(
    ...
    def asks(self) -> List[OrderBookRow]:
        # raise NotImplementedError("Coindcx order book messages have different semantics.")
        return [
