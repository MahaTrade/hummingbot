...
# from coindcx.client import Client as CoindcxClient


class CoindcxUserStreamTracker(UserStreamTracker):
    ...
    def __init__(self,
                 coindcx_auth: Optional[CoindcxAuth] = None):
        super().__init__()
        self._coindcx_client: CoindcxAuth = coindcx_auth
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            self._data_source = CoindcxAPIUserStreamDataSource(coindcx_auth=self._coindcx_client)
