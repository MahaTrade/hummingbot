...
from . import scallop_constants as Constants
...
def convert_from_exchange_trading_pair(base_asset: str, quote_asset: str) -> str:
...
KEYS = {
    "scallop_api_key":
        ConfigVar(key="scallop_api_key",
                  prompt="Enter your Scallop API key >>> ",
                  required_if=using_exchange("scallop"),
                  is_secure=True,
                  is_connect_key=True),
    "scallop_secret_key":
        ConfigVar(key="scallop_secret_key",
                  prompt="Enter your Scallop secret key >>> ",
                  required_if=using_exchange("scallop"),
                  is_secure=True,
                  is_connect_key=True),
}
