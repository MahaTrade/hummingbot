...
ScallopOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class ScallopActiveOrderTracker:
    def __init__(self,
                 active_asks: ScallopOrderBookTrackingDictionary = None,
                 active_bids: ScallopOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> ScallopOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> ScallopOrderBookTrackingDictionary:
