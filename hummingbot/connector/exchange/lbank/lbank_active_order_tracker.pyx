...
LBankOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class LbankActiveOrderTracker:
    def __init__(self,
                 active_asks: LBankOrderBookTrackingDictionary = None,
                 active_bids: LBankOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> LBankOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> LBankOrderBookTrackingDictionary:
