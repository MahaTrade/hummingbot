...
class LbankOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(LbankOrderBookMessage, cls).__new__(
    ...
    def asks(self) -> List[OrderBookRow]:
        # raise NotImplementedError("Lbank order book messages have different semantics.")
        return [
