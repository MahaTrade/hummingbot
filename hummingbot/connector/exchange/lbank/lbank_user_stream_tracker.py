...
# from lbank.client import Client as LbankClient


class LbankUserStreamTracker(UserStreamTracker):
    ...
    def __init__(self,
                 lbank_auth: Optional[LbankAuth] = None):
        super().__init__()
        self._lbank_client: LbankAuth = lbank_auth
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            self._data_source = LbankAPIUserStreamDataSource(lbank_auth=self._lbank_client)
