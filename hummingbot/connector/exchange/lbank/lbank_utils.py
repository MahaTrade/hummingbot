...
# Certain asset tokens is different from its name as per displayed on Lbank Exchange
...
KEYS = {
    "lbank_api_key":
        ConfigVar(key="lbank_api_key",
                  prompt="Enter your Lbank API key >>> ",
                  required_if=using_exchange("lbank"),
                  is_secure=True,
                  is_connect_key=True),
    "lbank_secret_key":
        ConfigVar(key="lbank_secret_key",
